...
varParam = srwl_bl.srwl_uti_ext_options([
    ['name', 's', 'FXI test 01', 'simulation name'],
...
#---Electron Beam
    ...
    ['ebm_dr', 'f', -3.7, 'electron beam longitudinal drift [m] to be performed before a required calculation'],
    ...
    ['ebm_sigx', 'f', 0.00013449907063, 'horizontal RMS size of electron beam [m]'],
    ['ebm_sigy', 'f', 5.21536192e-06, 'vertical RMS size of electron beam [m]'],
    ['ebm_sigxp', 'f', 6.69149605e-06, 'horizontal RMS angular divergence of electron beam [rad]'],
    ['ebm_sigyp', 'f', 1.53392998e-06, 'vertical RMS angular divergence of electron beam [rad]'],
...
#---Undulator
    ...
    ['und_by', 'f', 1.85, 'undulator vertical peak magnetic field [T]'],
    ...
    ['und_per', 'f', 0.1, 'undulator period [m]'],
    ['und_len', 'f', 7.0, 'undulator length [m]'],
...
#---Calculation Types
    ...
    ['w_rx', 'f', 0.0062, 'range of horizontal position [m] for calculation of intensity distribution'],
    ['w_nx', 'i', 100, 'number of points vs horizontal position for calculation of intensity distribution'],
    ['w_y', 'f', 0.0, 'central vertical position [m] for calculation of intensity distribution vs horizontal and vertical position'],
    ['w_ry', 'f', 0.0062, 'range of vertical position [m] for calculation of intensity distribution vs horizontal and vertical position'],
    ['w_ny', 'i', 100, 'number of points vs vertical position for calculation of intensity distribution'],
    #['w_smpf', 'f', 0.01, 'sampling factor for calculation of intensity distribution vs horizontal and vertical position'],
    ['w_smpf', 'f', 0.01, 'sampling factor for calculation of intensity distribution vs horizontal and vertical position'],
    ...
    #['w_prec', 'f', 0.0001, 'relative precision for calculation of intensity distribution vs horizontal and vertical position'],
